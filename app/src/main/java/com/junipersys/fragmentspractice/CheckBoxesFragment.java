...
public abstract class CheckBoxesFragment extends Fragment { //abstract means cannot be instanciated for this class
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        //When Bundle is available, can call getArguments
    ...
    public void onSaveInstanceState(@NonNull Bundle outState) {
        ...
        for(CheckBox box : mCheckBoxes){
            stateOfCheckBoxes[i] = box.isChecked();
            i++;
        }
